...
def build_bundle(attempt_id: str, language: str | None = None) -> RuntimeBundle:
    ...
    runtime_config = RuntimeConfig(
        # speechmatics (ar_en bilingual) is the default. SIM_STT_PROVIDER=deepgram switches to
        # nova-3, which the worker maps ar_en -> "ar" for, since Deepgram has no bilingual pack.
